  ...
  <div class="container mx-auto px-6 py-5">
    ...
    <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-3">
      <div class="flex flex-col sm:flex-row">
        ...
        <x-nav-link :href="route('home')" :active="request()->routeIs('home')" class="mt-3 text-gray-600 sm:mx-3 sm:mt-0">{{ __('Contact') }}</x-nav-link>
        <x-nav-link :href="route('home')" :active="request()->routeIs('home')" class="mt-3 text-gray-600 sm:mx-3 sm:mt-0">{{ __('About') }}</x-nav-link>
      </div>
    </nav>
